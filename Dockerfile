...
# Diffusion model
RUN comfy model download --url https://huggingface.co/pqhaz/klein-snofs/resolve/main/snofsSexNudesAndOtherFunStuff_v13Base.safetensors --relative-path models/diffusion_models --filename snofsSexNudesAndOtherFunStuff_v13Base.safetensors

# LoRA
RUN comfy model download --url https://huggingface.co/pqhaz/klein-snofs/resolve/main/kleinSnofsV13.safetensors --relative-path models/loras --filename kleinSnofsV13.safetensors
